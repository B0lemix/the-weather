<script>
    ...
    export let temperature,text,icon,code;
...
<section class="flex flex-row items-center justify-start self-stretch mx-8">
   <WeatherIcon/>
   <div class="w-full h-full justify-center items-start inline-flex">
